...
import { sendVerificationCode, verifyCodeAndLogin, authStorage } from '../services/authService';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">AI-Powered Financial Intelligence Platform</p>
        </div>
            ...
            <form onSubmit={handleVerifyCode} className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                ...
                <p className="text-xs text-blue-700">
                  We've sent a 6-digit verification code to your inbox. Please check your email and enter the code below.
                </p>
              </div>
